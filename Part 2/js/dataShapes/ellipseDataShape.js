/**
 * Implements DataShape base class for visualizing Ellipses
 */
class EllipseDataShape extends DataShape{

    constructor(x, y, width, height, index){
        super(x, y, width, height, index);
        this.buffer=[]; //Contains the parameter necessary to draw the last <bufferSize> shapes like a sort of visual echo
        this.bufferSize = 5; //Number of shapes to visualize for the current instance
    }
